// src/pages/Jardines/Detalle/components/ModalCrearSeccion.jsx
import { Dialog, Transition } from '@headlessui/react';
import { Fragment, useState } from 'react';
import { HiPlusCircle, HiX } from 'react-icons/hi';

export default function ModalCrearSeccion({ isOpen, onClose, onGuardar }) {
    ...
    <Transition show={isOpen} as={Fragment}>
      <Dialog as="div" className="relative z-50" onClose={onClose}>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          >
            <Dialog.Panel className="w-full max-w-md bg-white rounded-2xl shadow-xl p-6 relative max-h-[90vh] overflow-y-auto">
              <button
                onClick={onClose}
